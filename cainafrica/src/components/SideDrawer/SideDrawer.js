...
const sideDrawer = props => (
    <>
        <nav className="side-drawer"> 
            ...
            <ul>
                <li>
                    <Link onClick={props.closeDrawer} to="/home">Home</Link>
                </li>
                <li>
                    <Link onClick={props.closeDrawer} to="/mission">Mission</Link>
                </li>
                <li>
                ...
                <span >
                    <span>
                        <li>
                            <Link onClick={props.closeDrawer} to="executiveboard">Executive Board</Link>
                        </li>
                        <li>
                            <Link onClick={props.closeDrawer} to="ourmembers">Members</Link>
                        </li>
                        <li>
                            <Link onClick={props.closeDrawer} to="beavolunteer">Join Our Team</Link>
                        </li> 
                    </span>
                </span>
                <li>
